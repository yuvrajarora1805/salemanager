      ...
      <main className="flex-1 overflow-y-auto w-full">
        <header className="bg-white shadow-sm border-b px-4 md:px-8 py-4 flex items-center justify-between sticky top-0 z-40 hidden md:flex">
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-indigo-100 text-indigo-700 font-bold rounded-full flex items-center justify-center">
        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
          ...
          <div className="md:hidden mb-6 flex items-center gap-3">
             <div className="w-10 h-10 bg-indigo-100 text-indigo-700 font-bold rounded-full flex items-center justify-center text-xl">
              {session.user.name?.[0]?.toUpperCase()}
            </div>
