...
export default async function SalesLayout({
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-50 overflow-hidden">
      ...
      <aside className="w-full md:w-64 bg-blue-900 text-white flex flex-col flex-shrink-0">
        <div className="p-4 md:p-6 border-b border-blue-800 flex justify-between items-center md:block">
          <div className="flex items-center gap-3">
            <Image src="/logo.png" alt="Fuel Pump Logo" width={40} height={40} className="rounded-full bg-white p-1" />
            <div>
              <h2 className="text-xl md:text-2xl font-bold">Sales Panel</h2>
              <p className="text-blue-300 text-xs md:text-sm mt-1">FuelPump Operations</p>
            </div>
          </div>
        ...
        <nav className="flex md:flex-col overflow-x-auto px-2 md:px-4 py-3 md:py-6 space-x-2 md:space-x-0 md:space-y-2 whitespace-nowrap">
          <Link href="/sales" className="inline-block md:block px-4 py-2 rounded hover:bg-blue-800 transition">
            New Sale
          </Link>
          <Link href="/sales/customers/new" className="inline-block md:block px-4 py-2 rounded hover:bg-blue-800 transition">
            Add Customer
          </Link>
        </nav>
